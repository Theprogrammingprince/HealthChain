...
export default function ClinicalDashboardPage() {
    ...
    const { walletAddress, currentStaff, disconnectWallet, authenticateUser, isAuthorized, checkAuthorization } = useAppStore();
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="bg-[#0A0A0A] border-white/10 text-white w-56 p-2 rounded-2xl shadow-2xl">
                                    ...
                                    <DropdownMenuItem className="focus:bg-white/5 cursor-pointer rounded-xl p-3">
                                        <Settings className="w-4 h-4 mr-2" /> Clinical Prefs
                                    </DropdownMenuItem>
